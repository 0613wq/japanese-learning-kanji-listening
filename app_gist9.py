...
<body>
  ...
  <div class="toggles">
    <label><input type="checkbox" id="tglWord" checked> 显示日语</label>
    <label><input type="checkbox" id="tglMean" checked> 显示中文</label>
...
(function() {
  ...
  const tglWord      = document.getElementById('tglWord');
  const tglMean      = document.getElementById('tglMean');
  ...
  function updateDisplay() {
    ...
    if (!tglWord.checked) wCls += ' hidden-text';
    if (!tglMean.checked) mCls += ' hidden-text';
  ...
  tglWord.addEventListener('change', updateDisplay);
  tglMean.addEventListener('change', updateDisplay);
